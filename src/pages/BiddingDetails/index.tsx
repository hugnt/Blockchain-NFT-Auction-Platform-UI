...
export default function BiddingDetails() {
  return (
    <div className="py-12">
      <div id="auction-details" className="container max-w-7xl flex justify-between">
          ...
          <div id="bidding-nft" className="overflow-hidden rounded-[20px]">
            ...
            <div id="nft-infor" className="py-4 px-8">
              ...
              <div id="nft-details-infor">
                <div id="nft-name" className="text-4xl font-semibold my-6">Amazing Digital Art</div>
                ...
                <span className="cursor-pointer" style={{ color: "rgba(0, 255, 117, 0.50)" }}>
                  Read More
                </span>
              </div>
            </div>
        ...
        <div id="bidding-action" className="ms-10 w-4/12 ">
          <div id="bid-action-box" className="top-12 mb-12 py-8 rounded-[20px] border border-fog-2 bg-fog-1 overflow-hidden flex flex-col items-center">
              ...
              <div id="bid-action-exchange-usd" className="my-3 font-semibold text-fog-2">$564.36</div>
              <div>Auctions ends in</div>
              <div id="bid-action-time-end" className="font-semibold">00D 00:00:00</div>
              <div id="bid-action-btn" className="w-5/6 border-fog-2 border-t mt-6 pt-6">
                <button className="mb-3 w-full rounded-lg bg-fog-1 py-1.5 border border-fog-2">Place a bid</button>
                <button className="w-full rounded-lg bg-fog-1 py-1.5 border border-fog-2">Buy</button>
              </div>
          </div>
        </div>
      </div>
